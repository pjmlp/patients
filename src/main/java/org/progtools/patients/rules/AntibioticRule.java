/* AntibioticRule.java - Defines the rules for antibiotics.
...
/**
 * Cures tuberculosis, changing the patient state to healthy.
 */
public class AntibioticRule implements  TreatmentRule {
    ...
    public Patient applyTreatment(Patient patient, Set<Drugs> drugs) {
        if (patient.getState() == States.Tuberculosis && drugs.contains(Drugs.Antibiotic)) {
